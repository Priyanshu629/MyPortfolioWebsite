const img = "https://avatars.githubusercontent.com/u/104246169?v=4";
...
const About = () => (
  <div className="about">
    <div className="info">
      ...
      <p>
        My name is Priyanshu kumar mishra and I live in kolkata , West Bengal .
        ...
        position in IT companies in future
      </p>
      <a href="#contact" id="btn">
        Contact Me
      </a>
